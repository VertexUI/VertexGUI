...
@propertyWrapper
open class ObservableProperty<V>: ObservableProtocol {
  ...
  open var projectedValue: ObservableProperty<Value> {
    return self
  }

  open var any: AnyObservableProperty  {
    AnyObservableProperty(self)
  }

  open var binding: ObservablePropertyBinding<Value> {
