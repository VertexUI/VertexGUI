...
open class SDL2OpenGL3NanoVGDrawingBackend: DrawingBackend {
  ...
  override public func activate() {
    nvgBeginFrame(surface.nvg, Float(Double(surface.size.width) / surface.resolution), Float(Double(surface.size.height) / surface.resolution), Float(surface.resolution))
  }
