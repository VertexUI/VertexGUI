            ...
            for index in 0..<lines.count {
                ...
                for item in line.items {
                    ...
                    if item.grow > 0 {
                        ...
                        newConstraints.minSize[mainAxisVectorIndex] = content.bounds.size[mainAxisVectorIndex] + itemGrow
                        newConstraints.maxSize[mainAxisVectorIndex] = content.bounds.size[mainAxisVectorIndex] + itemGrow
                        relayout = true
                    }
